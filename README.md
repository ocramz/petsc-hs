...
6/12/2015 : We're integrating the [SLEPc](slepc.upv.es/) eigensolver suite, which is based on PETSc, and provides many options for spectral decomposition of sparse operators, e.g. (non)linear and polynomial eigensolvers, spectral transformation facilities for accelerated convergence, etc. 
