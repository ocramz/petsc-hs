...
stack --extra-include-dirs="$PETSC_INCLUDE1" --extra-include-dirs="$PETSC_INCLUDE2" --extra-include-dirs="$SLEPC_INCLUDE1" --extra-include-dirs="$SLEPC_INCLUDE2" --extra-lib-dirs="$PETSC_LIB" --extra-lib-dirs="$SLEPC_LIB" exec petsc-example
